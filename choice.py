...
# choose the least failures path (cycles acd and bccd)
def create(model):
    print("choice")
    ...
    pve.add_transition("b",["plant","environment"],[["g1"],["e1"]],[["g2"],["e4"]])
    pve.add_transition("c",["plant","environment"],[[],["e2","e4","e5"]],[[],["e3","e5","e6"]])
    pve.add_transition("d",["plant","environment"],[["g2"],["e3","e6"]],[["g1"],["e1","e1"]])
