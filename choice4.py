...
def create(model):
    ...
    pve.add_transition("a",["plant","environment"],[["g1"],["e1"]],[["g1"],["e2"]])
    pve.add_transition("b",["plant","environment"],[["g1"],["e1"]],[["g1"],["e3"]])
    pve.add_transition("c",["plant","environment"],[[],["e2","e3","e4"]],[[],["e1","e4","e1"]])
